...
<%
    ...
    int pageOffset = Integer.parseInt(request.getParameter("iDisplayStart"));
     ...
     */
    String[] sortFieldIds = new String[]{request.getParameter("iSortCol_0")};
     ...
     */
    int sortOrder = request.getParameter("sSortDir_0").equals("desc") ? 2 : 1;
    ...
    out.println("\"iTotalRecords\" : " + count + ",");
    out.println("\"iTotalDisplayRecords\" : " + count + ",");
    out.println("\"aaData\" : [");
